%[a,b,c,d,bc,dn,confmat,res]=part_agree_coef(c1,c2)
%
%    Calculates the Rand, adjusted Rand, Wallace, and 
%    other partition comparison coefficients.
%
%Outputs:
%
%    ri   = rand Index
...
function [res]=part_agree_coef(c1,c2)
    ...
    if t1==nc
       res.AR=0;            %avoid division by zero; if k=1, define Rand = 0
    else
       res.AR=(A-nc)/(t1-nc);       %adjusted Rand - Hubert & Arabie 1985
